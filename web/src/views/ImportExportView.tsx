...
export default function ImportExportView({
  ...
  async function prepareImport(file: File) {
    ...
    try {
      ...
      if (nextPreview.valid) {
        ...
        setMessage("JSON validado. Revisa el preview antes de restaurar.");
      } else {
        setError("El JSON no pasó la validación. Revisa los detalles antes de continuar.");
      }
    } catch {
  ...
  async function confirmImport() {
    ...
    try {
      ...
      setError("No se pudo restaurar el JSON validado.");
    } finally {
      ...
      <section className="export-grid">
        <article className="panel export-card">
          ...
          <div>
            ...
            <p>Valida el archivo, muestra un preview y descarga un backup previo automático.</p>
          </div>
          <input
          ...
          >
            ...
            {isPreviewing ? "Validando..." : isImporting ? "Restaurando..." : "Subir JSON"}
          </button>
        </article>
