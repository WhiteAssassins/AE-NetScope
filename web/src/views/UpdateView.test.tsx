...
const installedVersion = {
  ...
  release_notes_url: "https://github.com/WhiteAssassins/AE-NetScope/releases/tag/v0.1.3-alpha",
};
...
describe("UpdateView", () => {
            ...
            jsonResponse([
              {
                ...
                html_url: "https://github.com/WhiteAssassins/AE-NetScope/releases/tag/v0.1.3-alpha",
                name: "AE NetScope v0.1.3-alpha",
                prerelease: true,
                draft: false,
  ...
  it("shows current installed version and upgrade checklist", async () => {
    ...
    expect(screen.getByText("v0.1.3-alpha")).toBeInTheDocument();
  ...
  it("shows update available after manual check", async () => {
    ...
    expect(screen.getByRole("link", { name: /abrir release/i })).toHaveAttribute(
      "href",
      "https://github.com/WhiteAssassins/AE-NetScope/releases/tag/v0.1.4-alpha",
    );
  });
});
