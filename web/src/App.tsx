...
type ViewName = "dashboard" | "devices" | "ipMacs" | "networks" | "vlans" | "services";
  ...
  return (
    <>
      <div className="page-title page-title-row">
        <div>
          <h1>Subredes</h1>
          <p>Rangos CIDR, gateways, VLANs y ocupacion de direcciones.</p>
        </div>
        <button
          className="primary-action"
          onClick={() => {
...
function VlansView({
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (!response.ok) {
        setError("No se pudo guardar la VLAN. Revisa ID duplicado o campos invalidos.");
        return;
      }
  ...
  return (
    <>
      <div className="page-title page-title-row">
        <div>
          <h1>VLANs</h1>
          <p>Segmentos logicos, subredes asociadas y capacidad por VLAN.</p>
        </div>
        <button
          className="primary-action"
          onClick={() => {
