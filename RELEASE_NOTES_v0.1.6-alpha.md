...
AE NetScope v0.1.6-alpha is an early public preview focused on passive topology, safer update handling, Docker/TrueNAS smoke validation, and stronger release checks.
...
- Container image target: `ghcr.io/whiteassassins/ae-netscope:v0.1.6-alpha`.
